...
class TrainTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self._recovery_dismiss.setObjectName("af_icon_btn")
        self._recovery_dismiss.setFixedSize(28, 28)
        self._recovery_dismiss.setToolTip("Dismiss — don't resume this run")
